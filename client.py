...
def run():
    ...
    print("start_game : " , role) # [0,1,2,2,2,3,3]
    ############################
    ...
    print_stage(nextStage(stub,room_name=room_name , stage_name=""))
    #### 5投2 6投2 ####
    print(sendUserOperation(stub , user=5 , operation="vote" , target=3 , chat="" , room_name=room_name , stage_name="1-0-werewolf"))
    print(sendUserOperation(stub , user=4 , operation="vote" , target=3 , chat="" , room_name=room_name , stage_name="1-0-werewolf"))


    #### 第一天預言家驗人 ####
    print_stage(nextStage(stub,room_name=room_name , stage_name="1-0-werewolf"))
    #### 0投2 ####
    print(sendUserOperation(stub , user=0 , operation="vote" , target=7 , chat="" , room_name=room_name , stage_name="1-0-seer"))
    ...
    print(sendUserOperation(stub , user=1 , operation="vote_or_not" , target=5 , chat="poison" , room_name=room_name , stage_name="1-0-witch")) # false

    ### 平安夜 ###
    print_stage(nextStage(stub,room_name=room_name , stage_name="1-0-check_end1"))
    print(sendUserOperation(stub , user= 3 , operation="dialogue" , target=5 , chat="13456" , room_name=room_name , stage_name="1-1-check"))
    #### 第一天發言 ####
    print_stage(nextStage(stub,room_name=room_name , stage_name="1-0-dialogue"))
    print(sendUserOperation(stub , user= 5 , operation="dialogue" , target=5 , chat="7777" , room_name=room_name , stage_name="1-1-check"))
    print("!!!")
    ...
    for i in range(5):
        ...
        print_stage(nextStage(stub,room_name=room_name , stage_name="1-0-dialogue"))
        for i in range(7):
            print(sendUserOperation(stub , user= i , operation="dialogue" , target=5 , chat="13456" , room_name=room_name , stage_name="1-1-dialogue"))
    ...
    #### 第一天6獵人死掉發言及發動技能 ####
    #### 0,1,2,3,4,5 存活 ####
    # print(sendUserOperation(stub , user=6 , operation="vote_or_not" , target=4 , chat="" , room_name=room_name , stage_name="1-1-hunter"))
    # print(sendUserOperation(stub , user=6 , operation="dialogue" , target=0 , chat="555555" , room_name=room_name , stage_name="1-1-hunter"))
    ####################
    ...
    print(sendUserOperation(stub , user=4 , operation="vote" , target=0 , chat="" , room_name=room_name , stage_name="2-0-werewolf"))
    ####################
